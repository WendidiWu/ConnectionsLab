    ...
    .then(data => {
        ...
        for (let i = 0; i < 5; i++) {
            ...
            if (events[eventIndex].pages[0].thumbnail && events[eventIndex].pages[0].thumbnail.source) {
                ...
                eventImage.src = './assets/event_image_placeholder.jpeg'; //set a placeholder if no image exists
            }
        }
        ...
        if (births[0].pages[0].thumbnail && births[0].pages[0].thumbnail.source) {
            ...
            birthImage1.src = './assets/birth_image_placeholder.jpeg'; //set a placeholder if no image exists
        }
